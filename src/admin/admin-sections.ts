...
import type { TemplateKey } from '../lib/types.js';
import type { TemplateStyle, ServiceModule } from '../lib/branch-config.js';
import { getBranchConfig, isExtraBranch } from '../lib/branch-config.js';
import { getCatalogForVariant } from '../lib/page-layout.js';
import { BRANCH_STYLE_ORDER, type Style } from '../lib/template-orders.js';
