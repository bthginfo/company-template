...
export const BRANCH_TEXT_DEFAULTS: Record<TemplateKey, BranchTextDefaults> = {
  ...
  wedding: {
    teaserSubtitle:
      'Wir heiraten! Alle Infos zu unserem großen Tag – Programm, Location und eure Rückmeldung.',
    marqueeWords: ['Liebe', 'Ja-Wort', 'Feier', 'Freude', 'Zusammen', 'Für immer'],
    galleryTeaserTitle: 'Momente.',
    galleryTeaserEyebrow: 'Galerie',
    aboutTeaserEyebrow: 'Unsere Geschichte',
    faqEyebrow: 'Häufig gefragt',
    faqTitle: 'Gut zu wissen.',
    learnMoreLabel: 'Unsere Geschichte',
    learnMoreHref: '/ueber-uns',
    galleryAllLabel: 'Alle Bilder',
    galleryAllHref: '',
    testimonialsEyebrow: 'Gästebuch',
    testimonialsTitle: 'Worte, die uns berühren.',
    aboutTestimonialsEyebrow: '',
    aboutTestimonialsTitle: '',
    manifestEyebrow: 'Unser Motto',
    manifestTitle: 'Liebe ist das, was zählt.',
    softCtaEyebrow: 'Kommt ihr?',
    softCtaTitle: 'Wir freuen uns auf euch.',
    softCtaText: 'Bitte gebt uns bis zum Stichtag Bescheid.',
    softCtaButton: 'Jetzt zusagen',
    processEyebrow: 'Ablauf',
    processTitle: 'Unser Hochzeitstag.',
    galleryCategoriesEyebrow: 'Highlights',
    galleryCategoriesTitle: 'Was euch erwartet.',
    valuesEyebrow: 'Über uns',
    valuesTitle: 'So sind wir.',
    teamEyebrow: 'Trauzeugen & Co.',
    teamTitle: 'Die wichtigsten Menschen.',
    certsEyebrow: '',
    certsTitle: '',
    pressEyebrow: '',
    pressTitle: '',
    aboutSidebarEyebrow: 'Auf einen Blick',
    servicesTeaserEyebrow: 'Programm',
    servicesTeaserTitle: 'Programm & Details.',
    servicesAllLabel: 'Zum Programm',
    servicesAllHref: '/programm',
    serviceCardNote: '',
    heroEyebrow: '',
    heroImageUrl: '',
    servicesPageImageUrl: '',
    newsEyebrow: 'Neuigkeiten',
    newsTitle: 'News rund um unsere Hochzeit.',
    newsAllLabel: '',
    newsAllHref: '',
  },
};
