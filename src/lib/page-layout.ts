...
export const SECTION_CATALOG: Record<PageId, SectionDef[]> = {
  home: [
    ...
    { key: 'services',     label: 'Leistungen / Speisekarte', description: 'Liste und Reihenfolge unter „Leistungs-Teaser“; auf der Startseite werden nur die obersten Einträge im Teaser gezeigt.' },
    ...
    { key: 'numbers',      label: 'Zahlen-Band',              description: 'Eckdaten-Band (Zahl + Beschriftung); oft vier Einträge, mehr oder weniger möglich.' },
    { key: 'testimonials', label: 'Bewertungen',              description: 'Zitate-Reihenfolge hier oder unter „Über uns“ mit ↑↓. Bei Kern-Branchen sind oft drei auf der Startseite sichtbar; bei Consulting/Medical/Fitness mehr.' },
  ...
  services: [
    { key: 'highlights',   label: 'Highlights-Ribbon',        description: 'Kurze Info-Karten unter dem Seiten-Header.' },
    { key: 'list',         label: 'Leistungs-Liste',          description: 'Nutzt dieselben Einträge wie „Startseite → Leistungs-Teaser“; nur Darstellung auf dieser Seite.' },
    ...
    { key: 'testimonials', label: 'Bewertungen',              description: 'Dieselbe Liste wie unter Über uns oder Startseite — hier nur zusätzlich einbindbar.' },
    { key: 'gallery',      label: 'Galerie-Vorschau',         description: 'Bilder und Reihenfolge unter „Galerie“ pflegen; hier wird nur eine Auswahl dieser Liste angezeigt.' },
  ...
  gallery: [
    ...
    { key: 'testimonials', label: 'Bewertungen',              description: 'Gleiche Bewertungsliste wie unter Über uns — nur zusätzlich auf dieser Seite platziert.' },
    { key: 'cta',          label: 'Abschluss-CTA',            description: 'CTA-Band oberhalb des Footers.' },
  ],
  about: [
    ...
    { key: 'testimonials',  label: 'Bewertungen',             description: 'Hier die volle Liste pflegen; dieselben Einträge können auf der Startseite (Teaser) und woanders erscheinen.' },
    { key: 'faq',           label: 'FAQ',                     description: 'Häufig gestellte Fragen.' },
    { key: 'cta',           label: 'Abschluss-CTA',           description: 'CTA-Band oberhalb des Footers.' },
  ],
  contact: [
